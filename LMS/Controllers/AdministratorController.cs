...
namespace LMS.Controllers
{
    public class AdministratorController : Controller
    {
        ...
        {
            //First, create a new department object
            ...
            try
            {
                // Try to add the new department and return false if unable to
        ...
        {   // Create a new course object. The CatalogID field is automatically
            // determined when the course is added
        ...
        public IActionResult CreateClass(string subject, int number, string season, int year, DateTime start, DateTime end, string location, string instructor)
        {
            ...
            // Get the catalog id
            var query = (from c in db.Courses
                        where c.Number == number && c.Department == subject
                        select new
                        {
                            courseID = c.CatalogId
                        }).Single();

            // Check for overlapping classes
            var checkOverlap = from c in db.Classes
            ...
            newClass.Listing = query.courseID;
